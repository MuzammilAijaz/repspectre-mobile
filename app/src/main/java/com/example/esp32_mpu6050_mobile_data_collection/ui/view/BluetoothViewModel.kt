...
class BluetoothViewModel() : ViewModel() {
    ...
    public fun getBleCallback() : BluetoothGattCallback { return callback }
    ...
    val callback = object : BluetoothGattCallback() {
        override fun onConnectionStateChange(
            ...
            _uiState.update { currentState ->
                currentState.copy(connectionState = currentState.connectionState.copy(gatt = gatt, connectionState = newState))
            }
        ...
        override fun onMtuChanged(gatt: BluetoothGatt, mtu: Int, status: Int) {
            ...
            _uiState.update { currentState ->
                currentState.copy(connectionState = currentState.connectionState.copy(gatt = gatt, mtu = mtu))
            }
        }
        ...
        override fun onServicesDiscovered(gatt: BluetoothGatt, status: Int) {
            ...
            _uiState.update { currentState ->
                currentState.copy(connectionState = currentState.connectionState.copy(services = gatt.services))
            }
        ...
        override fun onCharacteristicWrite(
            ...
            _uiState.update { currentState ->
                currentState.copy(connectionState = currentState.connectionState.copy(messageSent = status == BluetoothGatt.GATT_SUCCESS))
            }
        }
        ...
        private fun doOnRead(value: ByteArray) {
            ...
            _uiState.update { currentState ->
                currentState.copy(connectionState = currentState.connectionState.copy(messageReceived = "Accel: x=$accelX y=$accelY z=$accelZ"))
            }
        }
    }
