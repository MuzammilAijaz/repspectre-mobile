...
@Database(entities = [AccelerationEntity::class, SessionEntity::class, QuaternionEntity::class, RawDataEntity::class, LiftContextEntity::class, LiftCategoryTypeEntity::class, MotionStateTypeEntity::class, SensorDataFormatType::class, TempoTypeEntity::class], version = 16, exportSchema = false)
